...
> Complete field and index definitions for tables used in iPurchase administration screens.
>
> This reference complements the [System Settings Reference](system-settings-reference.md) which documents the 550+ configuration parameters stored in `pf_mstr`.

| | |
|--|--|
| **Database** | `wdm` (PROGRESS/OpenEdge) |
| **Tables Documented** | 23 |
| **Source** | Schema export `wdm.txt` |
