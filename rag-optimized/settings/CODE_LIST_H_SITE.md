...
Configures the source for the Header Site dropdown list in requisitions.

### How It Works

This setting controls where iPurchase gets the list of valid values for the Header Site field. It can point to:
