...
Configures the source for the User Character Field 2 dropdown list in requisitions.

### How It Works

This setting controls where iPurchase gets the list of valid values for the User Character Field 2 field. It can point to:
