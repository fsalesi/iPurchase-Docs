...
This setting allows the administrator to enter a buyers signature based on the site in the buyer user record The value of this setting is a path to the physical file name on the app server. Ex " or apps or iPurchase or signatures or frank.jpg". If the signature is in the wdm or agents folder then you only need to put filename not path. Ex "frank.jpg". The signature file should be 250x60 pixels.
