...
This setting allows the administrator to enter a buyers signature based on the domain and the site of the buyer user record The value of this setting is a path to the physical file name on the app server.
