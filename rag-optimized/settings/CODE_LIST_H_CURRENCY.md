...
Configures the source for the Header Currency dropdown list in requisitions.

### How It Works

This setting controls where iPurchase gets the list of valid values for the Header Currency field. It can point to:
- A QAD table (like cu_mstr)
...
| Value | Behavior |
|-------|----------|
| Blank | Use default QAD table (cu_mstr) |
