...
Configures the source for the User Character Field 3 dropdown list in requisitions.

### How It Works

This setting controls where iPurchase gets the list of valid values for the User Character Field 3 field. It can point to:
