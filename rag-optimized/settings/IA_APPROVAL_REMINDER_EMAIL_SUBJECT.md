# IA_APPROVAL_REMINDER_EMAIL_SUBJECT - iPurchase System Setting
...
| Property | Value |
|----------|-------|
| **Setting Name** | IA_APPROVAL_REMINDER_EMAIL_SUBJECT |
| **Category** | iApprove Integration |
| **Owner** | Admin |
...
WHERE pf_us_id = 'SYSTEM' AND pf_group = 'DEFAULT' AND pf_attr = 'IA_APPROVAL_REMINDER_EMAIL_SUBJECT'
```
